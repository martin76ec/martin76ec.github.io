...
export function ExperienceCard({ exp }: { exp: Experience }) {
  return (
    <div className="border-1 flex min-h-64 w-full flex-col gap-2 rounded border border-muted/80 bg-muted/50 px-8 py-6 hover:bg-accent backdrop-blur-md md:flex-row md:gap-24 lg:gap-8 select-none">
