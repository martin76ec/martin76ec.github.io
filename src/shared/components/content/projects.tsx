...
export function ProjectCard({ project }: ProjectCardProps) {
  return (
    <a href={project.link} target="_blank" rel="noreferrer">
      <div className="group/project flex w-full cursor-pointer flex-col-reverse gap-4 rounded py-6 px-8 bg-muted/50 backdrop-blur-md hover:bg-accent md:flex-row md:gap-24 lg:gap-8 min-h-64">
